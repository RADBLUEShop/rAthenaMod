...
struct PACKET_CZ_REQ_CASH_BARGAIN_SALE_ITEM_INFO{
	int16 packetType;
#if PACKETVER_MAIN_NUM >= 20190724 || PACKETVER_RE_NUM >= 20190724 || PACKETVER_ZERO_NUM >= 20190724
	char item_name[ITEM_NAME_LENGTH];
#elif PACKETVER_MAIN_NUM < 20190724 || PACKETVER_RE_NUM < 20190724 || PACKETVER_ZERO_NUM < 20190724
	int16 packetLength;
	uint32 AID;
	uint32 itemId;
#else
